...
class BlackjackBotApp:
    def __init__(self, root):
        ...
        self.limite_croupier = tk.StringVar()
        ...
        # Champs de saisie pour la configuration du bot
        self.make_entry("Mise de base :", self.mise_de_base)
        self.make_entry("Multiplicateur en cas de défaite :", self.multiplicateur)
        self.make_entry("Limite de pioche : croupier :", self.limite_croupier)
        self.make_entry("Arret Automatique a partir de :", self.limite_solde)
        ...
        self.bot_on = False
        self.bot_button = tk.Button(root, text="Démarrer", command=self.toggle_bot)
    ...
    def toggle_bot(self):
        ...
        if self.bot_on:
            ...
            # Interrompre le bot (vous devrez gérer cela dans la fonction run_bot)
            self.stop_bot()
